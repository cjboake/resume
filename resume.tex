...
\datesubsection{\sc{new interal portal}}
\workitem{Wrote persistence layer micro-services to organize and serve data from multiple types of SQL database,
as well as interact with Stratus mainframe.}
