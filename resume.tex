...
\workitem{Scratch-built C compiler that emits x86\_64 Assembly without the use of any pre-made Lexer/Parser Generator tools or libraries}
...
\workite{Unix network server written in C that utilizes a variety of data structures to store
and retrieve data upon which it performs statistical analysis.}
